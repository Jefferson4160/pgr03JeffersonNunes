 ...
 * @author ADMIN
 */
public class PagamentoCartao implements ItfPagamento {
    ...
    public double calcularTotal(){
        ...
        return valorFinal*1.05; //aplica a regra do pagamento em CARTÃO
    }
    @Override
    public void imprimirRecibo(){
        //Criação de uma string para guardas as informações do pagamento
        String recibo = "<html><div style='text-align: center;'>Pagamento Cartão</div><br><br>";
        //String.format me permite formatar o valor com duas casas decimais e depois inserir na String
        recibo += String.format("Sub-total: R$ %.2f<br><br>Valor com taxa de 5%%: R$ %.2f<br><br><html>", valor, calcularTotal());
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/br/com/ifba/atividade09/imagens/icons8-cartão-60.png"));
