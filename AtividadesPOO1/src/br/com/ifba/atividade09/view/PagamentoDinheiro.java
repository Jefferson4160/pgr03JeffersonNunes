 ...
 * @author ADMIN
 */
public class PagamentoDinheiro implements ItfPagamento {
    ...
    public double calcularTotal(){
        double subTotal = valor;
        return subTotal*0.90; //aplica a regra do pagamento em dinheiro, dando 10% de desconto
    }
    @Override
    public void imprimirRecibo(){
        ...
        recibo += String.format("Sub-total: R$ %.2f<br><br>Valor com desconto de 10%%: R$ %.2f<br><br><html>", valor, calcularTotal());
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/br/com/ifba/atividade09/imagens/icons8-dinheiro-64.png"));
